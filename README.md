# CreativeBakery landing page

- [DEMO LINK](https://nasytheslayer.github.io/CreativeBakeryLanding/)
...
```
$ git clone https://github.com/NasyTheSlayer/CreativeBakeryLanding.git
```

3. Open project in terminal (or GitBash for Windows users):
```
$ code CreativeBakeryLanding
```
